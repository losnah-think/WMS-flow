      ...
      <div className="grid grid-cols-2 gap-3">
        {previousStep ? (
          <div className="p-3 bg-gray-50 rounded-lg border-2 border-gray-200 hover:shadow-md transition">
            <p className="text-xs text-gray-500 font-semibold uppercase mb-1">이전 단계</p>
          ...
          <div className="p-3 bg-gray-50 rounded-lg border-2 border-dashed border-gray-300">
            <p className="text-xs text-gray-400 text-center">시작</p>
          </div>
        )}

        {nextStep ? (
          <div className="p-3 bg-blue-50 rounded-lg border-2 border-blue-200 hover:shadow-md transition">
            <p className="text-xs text-blue-600 font-semibold uppercase mb-1">다음 단계</p>
          ...
          <div className="p-3 bg-green-50 rounded-lg border-2 border-green-200">
            <p className="text-xs text-green-600 font-semibold text-center">완료</p>
          </div>
        )}
      </div>
    </div>
